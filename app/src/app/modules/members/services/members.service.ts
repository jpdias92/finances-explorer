...
export class MembersService {
    ...
    return this.httpClient.post(`${environment.host}/finances_explorer/members/`,
      {
        ...
        ...(formData.death_date.value && {"death_date": this.datepipe.transform(formData.death_date, 'yyyy-MM-dd')}),
        ...
        ...(formData.baptism_date.value && {"baptism_date": this.datepipe.transform(formData.baptism_date, 'yyyy-MM-dd')}),
        ...(formData.communion_date.value && {"communion_date": this.datepipe.transform(formData.communion_date, 'yyyy-MM-dd')}),
        ...(formData.confirmation_date.value && {"confirmation_date": this.datepipe.transform(formData.confirmation_date, 'yyyy-MM-dd')}),
  ...
  public putMember(member_id: string, formData: any) {
    ...
    return this.httpClient.put(`${environment.host}/finances_explorer/members/${member_id}`,
    {
      ...
      ...(formData.nationality && {"nationality": formData.nationality}),
      "birth_date": this.datepipe.transform(formData.birth_date.value, 'yyyy-MM-dd'),
      ...(formData.death_date.value && {"death_date": this.datepipe.transform(formData.death_date.value, 'yyyy-MM-dd')}),
      ...(formData.street_name && {"street_name": formData.street_name}),
      ...(formData.door_number && {"door_number": formData.door_number}),
      ...(formData.flat && {"flat": formData.flat}),
      ...(formData.postal_code && {"postal_code": formData.postal_code}),
      ...
      ...(formData.contact2 && {"contact2": formData.contact2}),
      ...(formData.email && {"email": formData.email}),
      ...(formData.baptism_date.value && {"baptism_date": this.datepipe.transform(formData.baptism_date.value, 'yyyy-MM-dd')}),
      ...(formData.communion_date.value && {"communion_date": this.datepipe.transform(formData.communion_date.value, 'yyyy-MM-dd')}),
      ...(formData.confirmation_date.value && {"confirmation_date": this.datepipe.transform(formData.confirmation_date.value, 'yyyy-MM-dd')}),
      ...(formData.marital_status && {"marital_status": formData.marital_status}),
      ...(formData.partner_id && {"partner_id": formData.partner_id}),
      ...(formData.occupation && {"occupation": formData.occupation}),
      ...(formData.professional_qualifications && {"professional_qualifications": formData.professional_qualifications}),
